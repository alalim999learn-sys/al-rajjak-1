    ...
    <main className="min-h-screen bg-[#f8fafc] py-0 md:py-16 px-0 md:px-4">
      ...
      <div className="min-h-screen md:min-h-0 max-w-4xl mx-auto bg-white md:shadow-[0_20px_50px_rgba(0,0,0,0.05)] md:rounded-[2.5rem] overflow-hidden border-0 md:border border-slate-100">
        ...
        <div className="px-6 md:px-12 pb-16 relative">
          ...
          {/* Header Info - IE University Madrid Portfolio */}
          <div className="text-center mt-8">
            ...
            <p className="text-slate-500 mt-2 font-medium flex items-center justify-center gap-2">
              <FaGraduationCap className="text-indigo-400" /> IE University, Madrid
            </p>
          </div>

          {/* Modern Contact Action Bar */}
          <div className="mt-10 flex justify-center gap-4">
            <a href="mailto:lucia.valero@ie.edu" className="group flex items-center gap-2 bg-slate-50 text-slate-700 px-4 py-2.5 rounded-xl hover:bg-rose-50 hover:text-rose-600 transition-all border border-slate-100">
              <FaEnvelope className="text-rose-500" /> 
              <span className="font-semibold text-sm hidden md:block">Email</span>
            </a>
            <a href="https://linkedin.com/in/luciavalero" target="_blank" className="group flex items-center gap-2 bg-slate-50 text-slate-700 px-4 py-2.5 rounded-xl hover:bg-blue-50 hover:text-blue-700 transition-all border border-slate-100">
              <FaLinkedin className="text-blue-600" /> 
              <span className="font-semibold text-sm hidden md:block">LinkedIn</span>
            </a>
            <a href="https://wa.me/34600000000" target="_blank" className="group flex items-center gap-2 bg-slate-50 text-slate-700 px-4 py-2.5 rounded-xl hover:bg-green-50 hover:text-green-700 transition-all border border-slate-100">
                ...
                <section>
                    ...
                    <div className="space-y-8 pl-4 border-l-2 border-indigo-100 ml-4">
                        <div className="relative">
                            ...
                            <h3 className="font-bold text-slate-900 text-lg">Business Development Intern</h3>
                            <p className="text-indigo-600 font-semibold text-sm">IE Business Club • 2025 - Present</p>
                        </div>
                        <div className="relative">
                            <div className="absolute -left-[25px] top-1 w-4 h-4 bg-slate-300 rounded-full border-4 border-white"></div>
                            <h3 className="font-bold text-slate-900 text-lg">International Strategy Assistant</h3>
                            <p className="text-indigo-600 font-semibold text-sm">Madrid Startup Hub • 2024 - 2025</p>
                        </div>
                    </div>
                </section>
            </div>
            ...
            <div className="md:col-span-5 space-y-12">
                ...
                <section className="bg-indigo-900 text-white p-8 rounded-[2rem] shadow-xl relative overflow-hidden">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-indigo-200 text-sm">IE University, Madrid</p>
                        <p className="text-indigo-300 font-medium mt-2">2023 - 2027</p>
                    </div>
                </section>
            </div>
          </div>
