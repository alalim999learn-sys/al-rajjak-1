...
export default function Navbar() {
  ...
  // এখানে সেই পেইজগুলোর লিস্ট দিন যেখানে নেভিবার থাকবে না

  const hiddenPages = ['/one', '/two', '/three', '/four', '/five', '/six', '/seven', '/eight'];

 

  // চেক করা হচ্ছে বর্তমান পাথ hiddenPages-এর মধ্যে আছে কি না
  ...
  // যদি হিডেন পেইজ হয় তবে কিছুই রিটার্ন করবে না (Navbar গায়েব হয়ে যাবে)
