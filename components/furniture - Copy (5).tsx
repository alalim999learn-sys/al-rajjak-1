                    ...
                    <div key={item.id} style={productCardStyle} onClick={() => setSelectedProduct(item)}>
                      ...
                      <div style={{ padding: '12px 10px' }}>
                        ...
                        <div style={{ marginTop: '8px' }}>
                          {hasDiscount && (
                            <div style={{ color: '#94a3b8', textDecoration: 'line-through', fontSize: '12px', fontWeight: '600' }}>
                              €{item.original_price}
                            </div>
                          )}
                          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                            ...
                            {hasDiscount && (
                              <span style={{ color: '#ef4444', fontSize: '11px', fontWeight: '900', background: '#fee2e2', padding: '1px 4px', borderRadius: '4px' }}>
...
const productCardStyle: React.CSSProperties = { background: '#fff', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)' };
...
const currentPriceStyle: React.CSSProperties = { color: '#059669', fontWeight: '900', fontSize: '19px' }; // BIGGER PRICE
